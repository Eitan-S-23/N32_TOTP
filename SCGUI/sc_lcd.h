...
#define  SC_PFB_BUF_SIZE    4096

#define  LCD_DMA_ISR_EN      1  //0单缓存模式，1双缓存模式

#define  LCD_DMA_WAP         1 //软件交换高低位
...
#define LIGHT_RED     0xE000U  
#define LIGHT_BLUE    0x183FU 
#define LIGHT_ORANGE    0xFC00U
#endif
